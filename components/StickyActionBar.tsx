...
export default function StickyActionBar({ siteConfig }: StickyActionBarProps) {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-50 no-print">
      <div className="grid grid-cols-4 gap-0">
        {/* Call */}
        <a
          href={`tel:${phone}`}
          onClick={handleCall}
          className="flex flex-col items-center justify-center py-3 hover:bg-gray-50 active:bg-gray-100 transition-colors"
        >
